...
public class InsuraceOrderActivity extends AppCompatActivity {
                ...
                .enqueue(new Callback<List<InsuranceInfo>>() {
                    ...
                    public void onResponse(Call<List<InsuranceInfo>> call, Response<List<InsuranceInfo>> response) {
                        if (response.body().size() != 0) {
                            ...
                            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(InsuraceOrderActivity.this,
                    ...
                    public void onFailure(Call<List<InsuranceInfo>> call, Throwable t) {
                        Toast.makeText(InsuraceOrderActivity.this,
                ...
                apiInsuranceService.CreateInsuranceContract(Common.user.getToken(),
                        ...
                        .enqueue(new Callback<ResponseBody>() {
                            ...
                            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                Toast.makeText(InsuraceOrderActivity.this, "Đặt mua bảo hiểm thành công", Toast.LENGTH_SHORT).show();
                                finish();
                            }

                            @Override
                            public void onFailure(Call<ResponseBody> call, Throwable t) {
                                Toast.makeText(InsuraceOrderActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
